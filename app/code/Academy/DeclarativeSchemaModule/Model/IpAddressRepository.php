...
use Academy\DeclarativeSchemaModule\Api\Data\IpAddressSearchResultsInterfaceFactory;
use Academy\DeclarativeSchemaModule\Api\IpAddressRepositoryInterface;
use Academy\DeclarativeSchemaModule\Model\ResourceModel\IpAddress as ResourceIpAddress;
use Academy\DeclarativeSchemaModule\Model\ResourceModel\IpAddress\CollectionFactory as IpAddressCollectionFactory;
...
class IpAddressRepository implements IpAddressRepositoryInterface
{
    ...
    public function save(
        \Academy\DeclarativeSchemaModule\Api\Data\IpAddressInterface $ipAddress
    ) {
        ...
        $ipAddressData = $this->extensibleDataObjectConverter->toNestedArray(
            $ipAddress,
            [],
            \Academy\DeclarativeSchemaModule\Api\Data\IpAddressInterface::class
        );
